...
export function Why() {
  return (
    <section className="relative border-y border-white/10 bg-ink-800/40 py-24">
      <div className="container-wide">
        <Reveal>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-white/60">We don't make toys. We make the centrepiece of your shelf.</p>
          </div>
        </Reveal>

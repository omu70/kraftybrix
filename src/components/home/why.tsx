          ...
          {features.map((f, i) => (
            <Reveal key={f.title} i={i}>
              <div className="group h-full bg-ink-900 p-8 transition-colors hover:bg-ink-800">
                <div className="grid h-12 w-12 place-items-center rounded-xl bg-brand-red/10 text-brand-red transition group-hover:bg-brand-red group-hover:text-zinc-900">
                  <f.icon size={22} />
                </div>

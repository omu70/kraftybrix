...
export function CookieConsent() {
  ...
  return (
    ...
    <div className="fixed inset-x-3 bottom-[150px] z-[35] mx-auto max-w-2xl rounded-2xl border border-black/10 bg-ink-800/95 p-3 shadow-card backdrop-blur-xl sm:p-4 lg:bottom-3 sm:flex sm:items-center sm:gap-4">

      ...
      <div className="w-full max-w-md">
        <div className="rounded-3xl border border-white/10 bg-ink-800 p-8">
          ...
          <button
            ...
            className="mt-6 flex w-full items-center justify-center gap-3 rounded-full border border-white/15 py-3 text-sm font-medium transition hover:bg-white/5"
          >
          ...
          <form className="space-y-3">
            {mode === "register" && (
              <input placeholder="Full name" className="w-full rounded-xl border border-white/15 bg-ink-900 px-4 py-3 text-sm outline-none focus:border-brand-red" />
            )}
            <div className="relative">
              <Mail size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-white/40" />
              <input type="email" placeholder="Email" className="w-full rounded-xl border border-white/15 bg-ink-900 py-3 pl-10 pr-4 text-sm outline-none focus:border-brand-red" />
            </div>
            <div className="relative">
              <Lock size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-white/40" />
              <input type="password" placeholder="Password" className="w-full rounded-xl border border-white/15 bg-ink-900 py-3 pl-10 pr-4 text-sm outline-none focus:border-brand-red" />
            </div>
